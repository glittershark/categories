...
_⟨_⟩₀ : ∀ {o ℓ e o′ ℓ′ e′} {C : Category o ℓ e} {D : Category o′ ℓ′ e′} → Functor C D → Category.Obj C → Category.Obj D
_⟨_⟩₀ = Functor.F₀

_⟨_⟩₁ : ∀ {o ℓ e o′ ℓ′ e′} {C : Category o ℓ e} {D : Category o′ ℓ′ e′} {A B : Category.Obj C} → (F : Functor C D) → C [ A ⇒ B ] → D [ F ⟨ A ⟩₀ ⇒ F ⟨ B ⟩₀ ]
_⟨_⟩₁ F = Functor.F₁ F
...
fmap : ∀ {o ℓ e o′ ℓ′ e′} {C : Category o ℓ e} {D : Category o′ ℓ′ e′} {A B : Category.Obj C} {F : Functor C D} → C [ A ⇒ B ] → D [ F ⟨ A ⟩₀ ⇒ F ⟨ B ⟩₀ ]
fmap {F = F} = Functor.F₁ F

fmap[_] : ∀ {o ℓ e o′ ℓ′ e′} {C : Category o ℓ e} {D : Category o′ ℓ′ e′} {A B : Category.Obj C} (F : Functor C D) → C [ A ⇒ B ] → D [ F ⟨ A ⟩₀ ⇒ F ⟨ B ⟩₀ ]
fmap[ F ] = Functor.F₁ F
